      ...
      {status === "success" ? (
        <div className={styles.success}>
          <p className={styles.successTitle}>
            {viaWhatsApp && whatsapp.enabled
              ? "Request received — continue on WhatsApp for a faster response."
          ...
          {viaWhatsApp && whatsapp.enabled && reference ? (
            <>
              <Button
                as="a"
                href={buildWhatsAppUrl(whatsapp.number, buildReferenceWhatsAppMessage(reference))}
                target="_blank"
                rel="noreferrer"
                variant="primary"
                size="md"
